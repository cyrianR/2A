...
c = imread('Images/photomontage_2.jpg');
...
u = c;
interieur = find(p>0);
u(i_r_min:i_r_max,j_r_min:j_r_max,:) = collage(r,s,interieur,mixed_gradient);
hold off;
imagesc(u);
axis image off;
