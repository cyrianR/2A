...
public class CasLimitesTest {
	...
	void testMethodePaquetage() {
		throw new RuntimeException("Une méthode de droit d'acces paquetage n'est pas un test !");
	}
	...
	public void testAvecParametre(int a) {
		throw new RuntimeException("Une méthode avec des parametres n'est pas un test !");
	}
